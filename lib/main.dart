...
_checkPermissionStatus() async {
  ...
  if (locationPermissionStatus.isGranted == false &&
      cameraPermissionStatus.isGranted == false &&
      storagePermissionStatus.isGranted == false &&
      locationPermissionStatus.isDenied == false &&
      cameraPermissionStatus.isDenied == false &&
      storagePermissionStatus.isDenied == false) {
...
class _MyAppState extends State<MyApp> {
  static const String title = 'EcoSaver';
